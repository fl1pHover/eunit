      ...
      <MainContainer>
        <Stack direction={"row"} py={2} gap={3}>
                ...
                <>
                  {filters.districts && (
                    ...
                    >
                      {filters.districts.map((d, ind) => {
                        return (
                          <option value={ind.toString()}>{d.district}</option>
                        );
                      })}
                    </Select>
                  )}
                  ...
                  {filters.rooms && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, room: e.target.value })
                      }
                      value={filter.room}
                    >
                      {filters.rooms.map((d, ind) => {
                        return <option value={ind.toString()}>{d}</option>;
                      })}
                    </Select>
                  )}
                  {filters.masterBedrooms && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, masterBedroom: e.target.value })
                      }
                  ...
                  {filters.bathrooms && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, bathroom: e.target.value })
                      }
                  ...
                  {filters.window && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, window: e.target.value })
                      }
                      value={filter.window}
                    >
                  ...
                  {filters.windows && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, windows: e.target.value })
                      }
                  ...
                  {filters.doors && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, doors: e.target.value })
                      }
                      value={filter.doors}
                    >
                  ...
                  {filters.balconies && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, balconies: e.target.value })
                      }
                      value={filter.balconies}
                    >
                      {filters.balconies.map((d, ind) => {
                        return <option value={ind.toString()}>{d}</option>;
                      })}
                    </Select>
                  )}
                  ...
                  {filters.garage && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, garage: e.target.value })
                      }
                      value={filter.garage}
                    >
                  ...
                  {filters.barter && (
                    <Select
                      ...
                      color={"mainBlossom"}
                      onChange={(e) =>
                        setFilter({ ...filter, barter: e.target.value })
                      }
                      value={filter.barter}
                    >
          ...
          >
            {/*Product */}
            {product.title && (
              <Heading variant={"mediumHeading"}>{product.title}</Heading>
            )}
            <Grid
            ...
            >
              ...
              <GridItem className="product__image-wrapper">
                ...
                >
                  <Stack direction={"row"}>
                    <Text>Зарын огноо: {product.date}</Text>
              ...
              <GridItem>
                <Grid templateColumns="repeat(2, 1fr)" gap={3}>
                  {product.info.map((p, i) => {
                    if(i != 1) {
                        return  <ProductInfo title={Object.keys(p)[0]} value={Object.values(p)[0]}/>
                    } 
                    return <ProductInfo >
                         <HStack p={2} justifyContent='center' gap={1}
          borderColor="bgGrey"
          borderWidth={2}
          borderRadius={5}>
                              {product.socials.facebook && <Link target={'_blank'} href={product.socials.facebook}><BsFacebook/></Link>}
                              {product.socials.instagram && <Link><BsInstagram/></Link>}
                         </HStack>
                    </ProductInfo>
