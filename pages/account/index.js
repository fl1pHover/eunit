  ...
  return (
    <MainContainer>
      <Tabs display={"flex"} my={10} gap={5}>
        <TabList width={"450px"} bgColor="white" py={7} rounded={10}>
          <VStack width={"full"} alignItems="flex-start">
            <VStack width={"full"}>
              <Avatar src="https://bit.ly/dan-abramov" size={"2xl"} mb={3} />
            ...
            <Tab
              ...
              justifyContent={"flex-start"}
              onClick={() =>
                router.push("/account?wallet", undefined, {
                  shallow: true,
                })
              }
            >
        ...
        <TabPanels bgColor={"white"} width="full" rounded={10} px={3}>
          <TabPanel>
