...
const Account = () => {
  return (
    <MainContainer py={5}>
      {/* <div className="absolute top-0 left-0 w-screen h-screen -z-20 bg-dark" /> */}
      <div className="flex justify-center gap-3">
        <div className="rounded-xl items-center text-[14px] bg-mainBlossom py-10 px-10 w-[25%] border-r border-r-bgGrey h-[70vh] shadow-md">
            ...
            <div className="flex-col items-start w-full my-8 text-[#a6c4d4]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p>
                    <span className="font-bold text-teal-500">35</span> - Нийт
                    зар
                  </p>
                </div>
                <div className="flex items-center gap-4">
        ...
        {/* <div className="flex w-[75%] rounded-xl  p-5 shadow-md"> */}
        <Profile />
        {/* </div> */}
      </div>
    </MainContainer>
